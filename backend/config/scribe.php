...
return [
    ...
    'description' => 'Task Management Module API - A comprehensive REST API for managing tasks, users, roles, and permissions with JWT authentication.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses JWT (JSON Web Token) authentication. To authenticate, first login via `POST /api/auth/login` to get your token, then include it in the Authorization header as `Bearer {token}`.',
    ],
